                ...
                {this.state.showLoader ? <CircularProgress /> :
                    <Paper style={{ margin: '5%' }} elevation={2}>
                        ...
                        <Grid item xs={6} sm={6} lg={6} xl={6} style={{ marginBottom: "5%" }}>
                            <Button variant="contained" color="primary" className={classes.button} onClick={() => { history.push(`${process.env.PUBLIC_URL}/translations`) }}>{translate('common.page.button.cancel')}</Button>
                            <Button variant="contained" color="primary" className={classes.buttons} onClick={this.handleSubmit.bind(this)}>{translate('dashboard.page.heading.title')}</Button>
                        </Grid>
                    </Paper>
                }
            </div>
