                        ...
                        if (tableMeta.rowData) {
                            return (
                                <div style={{ width: '120px' }}>
                                    {tableMeta.rowData[5] === 'COMPLETED' ? <a href={(process.env.REACT_APP_BASE_URL ? process.env.REACT_APP_BASE_URL : 'http://nlp-nmt-160078446.us-west-2.elb.amazonaws.com') + "/corpus/download-docx?filename=" + tableMeta.rowData[0] + '_t.docx'}><Tooltip title="Download"><DeleteOutlinedIcon style={{ width: "24", height: "24", marginRight: '8%', color: 'black' }} /></Tooltip></a> : ''}
