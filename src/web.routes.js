      ...
      <Router history={history} basename={'/dev'}>
        <div>
          <Switch>
            ...
            <PrivateRoute path={`${process.env.PUBLIC_URL}/benchmarktranslate`} userRoles={['analyzer']} component={FileTranslate} title="Benchmark Upload" authenticate={this.authenticateUser} />
