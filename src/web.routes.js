      ...
      <Router history={history} basename={'/dev'}>
        <div>
          <Switch>
            ...
            <PrivateRoute exact path={`${process.env.PUBLIC_URL}/translate`} forDemo drawer={true} title="SUVAS" component={TranslatePresident} authenticate={this.authenticateUser}/>
