      ...
      <Router history={history} basename={'/dev'}>
        <div>
          <Switch>
            ...
            <PrivateRoute exact path={`${process.env.PUBLIC_URL}/translate`} dontShowLoader forDemo title="Translate" userRoles={['user']} component={TranslatePresident} authenticate={this.authenticateUser} />
