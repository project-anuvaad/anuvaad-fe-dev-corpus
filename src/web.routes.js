      ...
      <Router history={history} basename={'/dev'}>
        <div>
          <Switch>
            ...
            <PrivateRoute exact path={`${process.env.PUBLIC_URL}/translate`} forDemo title="SUVAS" userRoles={['user']} component={TranslatePresident} authenticate={this.authenticateUser}/>
