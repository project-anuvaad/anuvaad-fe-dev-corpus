      ...
      <Router history={history} basename={'/dev'}>
        <div>
          <Switch>
            ...
            <PrivateRoute exact path={`${process.env.PUBLIC_URL}/translate-v2`} drawer={true} title="Anuvaad Translate" component={TranslatePresident} authenticate={this.authenticateUser}/>
